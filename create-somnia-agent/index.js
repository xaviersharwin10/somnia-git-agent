...
console.log(chalk.cyan('  npm install -g git-agent-cli'));
...
console.log('');
console.log(chalk.bold('Then set up GitAgent:'));
console.log(chalk.cyan('  git agent init'));
console.log(chalk.cyan('  git agent secrets set GROQ_API_KEY=your-key-here'));
